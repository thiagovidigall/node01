import DefaultFreightCalculator
  from '../src/ex_003_order/DefaultFreightCalculator';
import FixedFreightCalculator from '../src/ex_003_order/FixedFreightCalculator';
...
test("deve criar um pedido 3 itens com calculo do frete e estratégia default", function() {
    const order = new Order("839.435.452-10", new Date(), new DefaultFreightCalculator());
...
test("deve criar um pedido 3 itens com calculo do frete e estratégia fixa", function() {
    const order = new Order("839.435.452-10", new Date(), new FixedFreightCalculator());
    order.addItem(new Item(6, "Guitarra", "Aparelho musical", 1000, 100, 30, 10, 3), 1); 
    order.addItem(new Item(7, "Caixa Amplificada", "Aparelho musical", 5000, 100, 50, 50, 20), 1);
    order.addItem(new Item(8, "Cabo P2", "Acessórios", 30, 10, 10, 10, 0.9), 3);
    const freight = order.getFreight();
